...
struct ImFontAtlas
{
    ...
    IMGUI_API const ImWchar*    GetGlyphRangesFULL();                   // Full unicode (as much as possible)
    IMGUI_API const ImWchar*    GetGlyphRangesArabic();                 // Default + Arabic and Coptic
    ...
    //-------------------------------------
    IMGUI_API void EnableComplexTextLayout();
    IMGUI_API void DisableComplexTextLayout();
    //-------------------------------------
...
struct ImFont
{
    ...
    ImVector<ImWchar>           IndexRaqmLookup;        // 12-16 // out //            // Sparse. Index glyphs by Unicode code-point.
    ...
    IMGUI_API const ImFontGlyph*FindGlyphRaqm(int raqmIndex) const;
    ...
    // IMGUI_API static void              Text_to_ComplexUnicode(const char *text_begin, const char *text_end, const char *out_text_begin, const char *out_text_end );
};
